...
public class RegistryOvelha {
    ...
    public void adicionaPrototipo(String nomeOvelha, Ovelha ovelha){
        this.prototipos.put(nomeOvelha, ovelha);
    }
    
    public boolean removePrototipo(String nomeOvelha){
        if (this.prototipos.containsKey(nomeOvelha)){
            Ovelha ovelha = this.prototipos.get(nomeOvelha);
            this.prototipos.remove(ovelha);
            return true;
        }
        return false;
    }
